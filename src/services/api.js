...
export const equipmentAPI = {
  ...
  updateStatus: (id, data) => api.put(`/equipment/${id}/status`, data),
  ...
  checkAvailability: (id, params) => api.get(`/equipment/${id}/check-availability`, { params }),
...
export const vendorAPI = {
  ...
  withdrawEarnings: (data) => api.post('/payouts/withdrawal-request', data),
